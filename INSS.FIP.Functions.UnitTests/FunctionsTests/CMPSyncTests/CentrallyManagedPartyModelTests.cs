...
namespace INSS.FIP.Functions.UnitTests.FunctionsTests.CMPSyncTests
{
    public partial class CentrallyManagedPartyModelTests
    {
        ...
        public async Task Except_SourceRef_and_CMPModelProperties_should_return_emptystring_when_set_to_null(CentrallyManagedPartyModel input, CentrallyManagedPartyModel expected)
        {
            //Arrange
            //Act
            //Assert 
        ...
        [Theory]
        [MemberData(nameof(GetCMPModelTestData))]
        public async Task AddressLine1_should_always_return_an_emptystring(CentrallyManagedPartyModel input, CentrallyManagedPartyModel expected)
        {
            //Arrange
            //Act
            //Assert 
        ...
        [Theory]
        [MemberData(nameof(GetCMPModelTestData))]
        public async Task SourceRef_should_return_nonemptystrings_or_null(CentrallyManagedPartyModel input, CentrallyManagedPartyModel expected)
        {
            //Arrange
            //Act
            //Assert 
