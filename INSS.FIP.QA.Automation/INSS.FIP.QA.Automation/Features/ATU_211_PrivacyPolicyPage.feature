Feature: ATU_211_PrivacyPolicyPage
...
Scenario: ATU_211 Verify the Privacy policy page
	Then the Privacy policy page is displayed with the correct URL, page title and header

@TermsAndConditions @Regression
Scenario: ATU_211 Verify the breadcrumb navigation on the Privacy policy page
...
@TermsAndConditions @Regression
Scenario: ATU_211 Verify the navigation of the 'personal information charter' link
...
@TermsAndConditions @Regression
Scenario: ATU_211 Verify the navigation of the 'cookies on GOV UK' link
